...
class ReporteController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('reportes.general', compact(
            'total_animales', 'machos', 'hembras', 'madres', 'padres', 'mautes',
            'produccion_leche_total', 'produccion_carne_total',
            'compras', 'ventas', 'total_gastos_operativos',
            'movilizaciones', 'reproducciones', 'inventario_insumos',
            'tratamientos_activos', 'tratamientos_historico', 'vacunas', 'genealogia',
            'desde', 'hasta'
        ));
    }
    ...
    {
        $request->validate(['animal_id' => 'required']);
        ...
        return view('reportes.poranimal', compact(
            'animal', 'produccion_leche', 'produccion_carne',
            'tratamientos', 'vacunas', 'reproduccion', 'genealogia'
        ));
    }

    public function porFechas(Request $request)
    {
        // Similar a index con filtros obligatorios
    ...
    public function reportePotreros() { return view('reportes.potreros.form'); }
    public function reporteCompras()  { return view('reportes.compras.form'); }
    public function reporteVentas()   { return view('reportes.ventas.form'); }
    public function reporteCarne()    { return view('reportes.carne.form'); }
    public function reporteLeche()    { return view('reportes.leche.form'); }
    ...
    public function reporteFinanciero()
    {
        ...
        $gastosOpMes = Gastos::where('inquilino_id', $inquilino)
            ->whereYear('fecha', $anioActual)
        ...
        return view('reportes.financiero', compact(
            'totalCompras', 'totalVentas', 'totalGastos', 'balance',
            'labels', 'dataVentas', 'dataGastos'
        ));
    }
    ...
    public function dashboard()
    {
        ...
        return view('reportes.dashboard', compact(
            'totalCompras', 'totalVentas', 'totalCarne', 'totalLeche',
            'totalPotreros', 'produccionTotal', 'totalAnimales'
        ));
    }
}